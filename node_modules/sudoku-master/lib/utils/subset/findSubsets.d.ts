 ...
 */
export declare function findSubsets<T extends object, X, Y>(data: LookupData<T, X, Y>, level: SubsetLevel): readonly FindSubsetResult<T, X, Y>[];
export declare function findSubsets<T extends object, X, Y>(level: SubsetLevel): (data: LookupData<T, X, Y>) => readonly FindSubsetResult<T, X, Y>[];
