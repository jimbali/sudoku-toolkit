 ...
 */
export declare const PATTERN_LINE_WITHOUT_CANDIDATES: RegExp;
/**
 ...
 */
export declare const PATTERN_LINE_WITH_SPACES: RegExp;
/**
 ...
 */
export declare const PATTERN_LINE_FROM_HODOKU: RegExp;
/**
 ...
 */
export declare const PATTERN_LINES_WITH_SPACES: RegExp;
/**
 ...
 * [3479][3679][8][37][47][5][2][1][349]`
 */
export declare const PATTERN_LINES_WITH_BRACKETS: RegExp;
/**
 ...
 * ..8..521.`
 */
export declare const PATTERN_NAKED_TABLE_WITHOUT_CANDIDATES: RegExp;
/**
 * Pattern for a table with no pencilmarks but empty cells instead (marked as
 ...
 * +---+---+---+`
 */
export declare const PATTERN_TABLE_WITHOUT_CANDIDATES: RegExp;
/**
 ...
 * +----------------------+----------------------+----------------------+`
 */
export declare const PATTERN_TABLE: RegExp;
/**
 ...
 * '----------------------'----------------------'----------------------'`
 */
export declare const PATTERN_TABLE_SUDOPEDIA: RegExp;
/**
 ...
 * `);
 */
export declare function parseGrid(stringGrid: string, addCandidates?: boolean, onlyCleanString?: boolean): SudokuGrid | null;
