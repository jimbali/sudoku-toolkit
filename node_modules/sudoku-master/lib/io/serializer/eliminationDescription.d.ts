import { EliminationResult } from "../../solver/logical/eliminating/types";
/**
 ...
 */
export declare function eliminationDescription(eliminationResult: EliminationResult): string;
