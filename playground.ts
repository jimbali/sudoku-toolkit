import { CellCoord, CellIndex, Digit, eliminateBasicFish, eliminateHiddenSubset, eliminateLockedCandidates, eliminateNakedSubset, getCandidates, GridIndex, houseIdentifier, isValidGrid, parseGrid, Pencilmarks, serializeGrid, solveFullHouse, solveHiddenSingle, solveLastDigit, solveNakedSingle, SubsetType, SudokuGrid } from 'sudoku-master'
...
import { any, concat, curry, equals, filter, forEach, intersection, not, prop, propEq, reduce, reduced, reject, toPairs, until, zip, zipObj, __ } from 'ramda'
...
const solveNext = (params: Solution): Solution => {
  ...
  // console.log(grid)
  grid = eliminateInvalidCandidates(grid)
  // console.log(grid)
...
const eliminateInvalidCandidates = (grid: SudokuGrid): SudokuGrid => {
  ...
  let deepIntersection = Array.from(map(zipped, (items) => [items[0][0], intersection(items[0][1], items[1][1])])) as [GridIndex, Pencilmarks][] 
...
// const arr = [[0,[1,3,8,9]],[1,[1,6,8]],[2,[1,6,8]],[6,[1,3,6,8,9]],[7,[3,6,8]],[9,[3,5,8,9]],[11,[4,5,6,8]],[14,[3,5,9]],[15,[3,4,6,8,9]],[17,[3,4,6,9]],[18,[1,3,5,7,9]],[19,[1,4,6,7]],[20,[1,4,5,6,7]],[23,[3,5,9]],[
//   24,[1,3,4,6,9]],[25,[3,4,6]],[27,[1,7,8]],[29,[1,4,7,8]],[30,[1,8]],[35,[4,7]],[37,[1,4]],[41,[1,5,9]],[42,[3,4,9]],[43,[3,4]],[45,[7,8]],[50,[8,9]],[51,[6,7,9]],[53,[6,7,9]],[55,[1,6,7,8]],[56,[1,5,6,7,8
//   ]],[63,[1,5,7,8]],[65,[1,5,7,8]],[66,[1,8]],[69,[1,4,5,7,8]],[71,[1,4,7]],[73,[1,6,8]],[78,[1,3,6,8]],[79,[3,6,8]],[80,[1,3,6]]] as [GridIndex, Pencilmarks][] 

// console.log(new Map(arr))

// console.log('981724365324615879765983142197836254642571938853249716476398521538162497219457683'.split(''))


// let zipped = [[[37,[1,4]],[37,[1,4]]],[[39,[5,9]],[39,[1,5,9]]],[[41,[1,5,9]],[41,[1,5,9]]]] as [GridIndex, Pencilmarks][][]
// let deepIntersection = Array.from(map(zipped, (items) => [items[0][0], intersection(items[0][1], items[1][1])]))
